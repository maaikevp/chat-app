...
6. Create a new Expo project by entering:

npx create-expo-app hello-world --template     (For future projects, you’d change “hello-world” to the new name of your app)
